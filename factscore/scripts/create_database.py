...
def build_db(
    data_db: str, table_name: str, data_path: str, max_passage_length: int = 256
):
    """
    ...
    Args:
        ...
        table_name: name of the corresponding table in the data_db
...
def get_all_titles(connection, table_name):
    """
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--table_name",
        help="name of the corresponding table in the data_db",
        required=True,
    )
    parser.add_argument(
        "--json_path",
    ...
    build_db(args.data_db, args.table_name, args.json_path, args.max_passage_length)
